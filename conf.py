...
BLOG_AUTHOR = "Pranay Anchuri"  # (translatable)
BLOG_TITLE = "Blockchain Data Science"  # (translatable)
...
BLOG_EMAIL = "panchuri@princeton.edu"
BLOG_DESCRIPTION = "Course website for COS Independent Seminar, Spring 2022 at Princeton University"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/pages/overview', 'Home', 'fa fa-home'),
